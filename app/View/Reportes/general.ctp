<?php
    ...
    $this->assign("title", "Reporte General");
    $this->assign("title-icon", "icon_book");
    
    $this->Html->addCrumb("<i class='icon_document_alt'></i> Reportes", '/Reportes/general', array("escape" => false));
    $this->Html->addCrumb("<i class='fa fa-map-marker'></i> General", "/Reportes/general", array("escape" => false));
    ...
    <legend>Especifica el intervalo de fechas</legend>
        ...
        <div class="form-group">
            ...
            <?= $this->Form->input("categoria_laboral", [
                "required" => true,
                "empty" => "Selecciona un Tipo de Contrato",
                "options" => array(
                    "1" => "Contratado",
                    "2" => "CAS"
                )
...
<?php echo $this->Html->scriptStart(["block" => "script"]); ?>
    $(document).ready(function() {
        ...
        $("#ReporteGeneralForm").submit(function() {
