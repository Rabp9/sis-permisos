<?php
    ...
    $this->assign("title", "Solicitar Permiso");
    $this->assign("title-icon", "fa fa-book");
    
    $this->Html->addCrumb("<i class='fa fa-book'></i> Permisos", '/Permisos', array("escape" => false));
    $this->Html->addCrumb("<i class='icon_plus'></i> Nuevo Permiso", "/Permisos/register", array("escape" => false));
...
?>
<fieldset>
    <legend>Registra una nueva Solicitud de Permiso</legend>
    <div class="form-group">
        <?= $this->Form->label("Per_DNI", "DNI", [
    ...
    <div class="form-group">
        <?= $this->Form->label("nombre_completo", "Nombre Trabajador",
            ["class" => "col-sm-2 control-label"]
        ); ?>
        <?= $this->Form->input("nombre_completo", [
            "readonly" => true,
            "value" => $trabajador["Trabajador"]["nombre_completo"]
        ]); ?>
    </div>
    <div class="form-group">
